...
# Form implementation generated from reading ui file 'c:\Code\git\mdp_p906_pc_controller\gui_source\gui_template\mainwindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBoxVoltage.setMaximum(36.0)
        ...
        self.spinBoxCurrent.setMaximum(5.5)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 196, 230))
        ...
        self.spinBoxPresetVoltage.setMaximum(36.0)
        ...
        self.tabPreset2 = QtWidgets.QWidget()
        self.tabPreset2.setObjectName("tabPreset2")
        self.verticalLayout_24 = QtWidgets.QVBoxLayout(self.tabPreset2)
        self.verticalLayout_24.setContentsMargins(5, 5, 5, 5)
        self.verticalLayout_24.setObjectName("verticalLayout_24")
        self.horizontalLayout_34 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_34.setContentsMargins(10, -1, 10, -1)
        self.horizontalLayout_34.setObjectName("horizontalLayout_34")
        self.comboPreset2 = QtWidgets.QComboBox(self.tabPreset2)
        self.comboPreset2.setMaximumSize(QtCore.QSize(140, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.comboPreset2.setFont(font)
        self.comboPreset2.setObjectName("comboPreset2")
        self.comboPreset2.addItem("")
        self.comboPreset2.addItem("")
        self.comboPreset2.addItem("")
        self.comboPreset2.addItem("")
        self.comboPreset2.addItem("")
        ...
        self.comboPreset2.addItem("")
        self.comboPreset2.addItem("")
        self.horizontalLayout_34.addWidget(self.comboPreset2)
        self.horizontalLayout_34.setStretch(0, 2)
        self.verticalLayout_24.addLayout(self.horizontalLayout_34)
        self.line_2 = QtWidgets.QFrame(self.tabPreset2)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        ...
        self.scrollArea_5 = QtWidgets.QScrollArea(self.tabPreset2)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 196, 230))
        ...
        self.comboPresetEdit2 = QtWidgets.QComboBox(self.scrollAreaWidgetContents_6)
        self.comboPresetEdit2.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        font.setPointSize(9)
        font.setBold(True)
        self.comboPresetEdit2.setFont(font)
        self.comboPresetEdit2.setObjectName("comboPresetEdit2")
        self.comboPresetEdit2.addItem("")
        self.comboPresetEdit2.addItem("")
        self.comboPresetEdit2.addItem("")
        self.comboPresetEdit2.addItem("")
        self.comboPresetEdit2.addItem("")
        ...
        self.comboPresetEdit2.addItem("")
        self.comboPresetEdit2.addItem("")
        self.horizontalLayout_40.addWidget(self.comboPresetEdit2)
        ...
        self.spinBoxPreset2Voltage = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_6)
        self.spinBoxPreset2Voltage.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.spinBoxPreset2Voltage.setFont(font)
        self.spinBoxPreset2Voltage.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBoxPreset2Voltage.setDecimals(2)
        self.spinBoxPreset2Voltage.setMinimum(0.0)
        self.spinBoxPreset2Voltage.setMaximum(36.0)
        self.spinBoxPreset2Voltage.setSingleStep(0.1)
        self.spinBoxPreset2Voltage.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        self.spinBoxPreset2Voltage.setObjectName("spinBoxPreset2Voltage")
        self.horizontalLayout_31.addWidget(self.spinBoxPreset2Voltage)
        ...
        self.label_43 = QtWidgets.QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.spinBoxPreset2Current = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_6)
        self.spinBoxPreset2Current.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.spinBoxPreset2Current.setFont(font)
        self.spinBoxPreset2Current.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBoxPreset2Current.setDecimals(3)
        self.spinBoxPreset2Current.setMinimum(0.0)
        self.spinBoxPreset2Current.setMaximum(10.0)
        self.spinBoxPreset2Current.setSingleStep(0.1)
        self.spinBoxPreset2Current.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        self.spinBoxPreset2Current.setProperty("value", 0.0)
        self.spinBoxPreset2Current.setObjectName("spinBoxPreset2Current")
        self.horizontalLayout_52.addWidget(self.spinBoxPreset2Current)
        ...
        self.label_44 = QtWidgets.QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.spinBoxPreset2OVP = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_6)
        self.spinBoxPreset2OVP.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.spinBoxPreset2OVP.setFont(font)
        self.spinBoxPreset2OVP.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBoxPreset2OVP.setDecimals(2)
        self.spinBoxPreset2OVP.setMinimum(0.0)
        self.spinBoxPreset2OVP.setMaximum(36.0)
        self.spinBoxPreset2OVP.setSingleStep(0.1)
        self.spinBoxPreset2OVP.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        self.spinBoxPreset2OVP.setProperty("value", 0.0)
        self.spinBoxPreset2OVP.setObjectName("spinBoxPreset2OVP")
        self.horizontalLayout_53.addWidget(self.spinBoxPreset2OVP)
        ...
        self.label_45 = QtWidgets.QLabel(self.scrollAreaWidgetContents_6)
        ...
        self.spinBoxPreset2OCP = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_6)
        self.spinBoxPreset2OCP.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.spinBoxPreset2OCP.setFont(font)
        self.spinBoxPreset2OCP.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBoxPreset2OCP.setDecimals(3)
        self.spinBoxPreset2OCP.setMinimum(0.0)
        self.spinBoxPreset2OCP.setMaximum(10.0)
        self.spinBoxPreset2OCP.setSingleStep(0.1)
        self.spinBoxPreset2OCP.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        self.spinBoxPreset2OCP.setProperty("value", 0.0)
        self.spinBoxPreset2OCP.setObjectName("spinBoxPreset2OCP")
        self.horizontalLayout_54.addWidget(self.spinBoxPreset2OCP)
        ...
        self.btnPreset2Save = QtWidgets.QPushButton(self.scrollAreaWidgetContents_6)
        font = QtGui.QFont()
        font.setFamily("Sarasa Fixed SC SemiBold")
        self.btnPreset2Save.setFont(font)
        self.btnPreset2Save.setObjectName("btnPreset2Save")
        self.verticalLayout_23.addWidget(self.btnPreset2Save)
        ...
        self.tabWidget.addTab(self.tabPreset2, "")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 196, 240))
        ...
        self.spinBoxSweepStart.setProperty("value", 1.0)
        ...
        self.spinBoxSweepStep.setMinimum(0.01)
        self.spinBoxSweepStep.setMaximum(30.0)
        self.spinBoxSweepStep.setSingleStep(0.01)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 152, 198))
        ...
        self.spinBoxWaveGenPeriod.setMinimum(0.01)
        ...
        self.spinBoxWaveGenLow.setProperty("value", 2.0)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 176, 301))
        ...
        self.doubleSpinBoxSampleRate = QtWidgets.QDoubleSpinBox(self.frameGraph)
        self.doubleSpinBoxSampleRate.setDecimals(0)
        self.doubleSpinBoxSampleRate.setMinimum(2.0)
        self.doubleSpinBoxSampleRate.setMaximum(200.0)
        self.doubleSpinBoxSampleRate.setStepType(QtWidgets.QAbstractSpinBox.AdaptiveDecimalStepType)
        self.doubleSpinBoxSampleRate.setProperty("value", 50.0)
        self.doubleSpinBoxSampleRate.setObjectName("doubleSpinBoxSampleRate")
        self.horizontalLayout_27.addWidget(self.doubleSpinBoxSampleRate)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonLastTab.setText(_translate("MainWindow", "◀"))
        self.labelTab.setText(_translate("MainWindow", "Title"))
        self.pushButtonNextTab.setText(_translate("MainWindow", "▶"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPreset), _translate("MainWindow", "预设组 (软件)"))
        self.comboPreset2.setItemText(0, _translate("MainWindow", "0"))
        self.comboPreset2.setItemText(1, _translate("MainWindow", "1"))
        self.comboPreset2.setItemText(2, _translate("MainWindow", "2"))
        self.comboPreset2.setItemText(3, _translate("MainWindow", "3"))
        self.comboPreset2.setItemText(4, _translate("MainWindow", "4"))
        self.comboPreset2.setItemText(5, _translate("MainWindow", "5"))
        self.comboPreset2.setItemText(6, _translate("MainWindow", "6"))
        self.comboPreset2.setItemText(7, _translate("MainWindow", "7"))
        self.comboPreset2.setItemText(8, _translate("MainWindow", "8"))
        self.comboPreset2.setItemText(9, _translate("MainWindow", "9"))
        self.label_39.setText(_translate("MainWindow", "修改预设"))
        self.comboPresetEdit2.setItemText(0, _translate("MainWindow", "1"))
        self.comboPresetEdit2.setItemText(1, _translate("MainWindow", "2"))
        self.comboPresetEdit2.setItemText(2, _translate("MainWindow", "3"))
        self.comboPresetEdit2.setItemText(3, _translate("MainWindow", "4"))
        self.comboPresetEdit2.setItemText(4, _translate("MainWindow", "5"))
        self.comboPresetEdit2.setItemText(5, _translate("MainWindow", "6"))
        self.comboPresetEdit2.setItemText(6, _translate("MainWindow", "7"))
        self.comboPresetEdit2.setItemText(7, _translate("MainWindow", "8"))
        self.comboPresetEdit2.setItemText(8, _translate("MainWindow", "9"))
        self.label_42.setText(_translate("MainWindow", "设定电压"))
        self.spinBoxPreset2Voltage.setSuffix(_translate("MainWindow", "V"))
        self.label_43.setText(_translate("MainWindow", "设定电流"))
        self.spinBoxPreset2Current.setSuffix(_translate("MainWindow", "A"))
        self.label_44.setText(_translate("MainWindow", "过压保护"))
        self.spinBoxPreset2OVP.setSuffix(_translate("MainWindow", "V"))
        self.label_45.setText(_translate("MainWindow", "过流保护"))
        self.spinBoxPreset2OCP.setSuffix(_translate("MainWindow", "A"))
        self.btnPreset2Save.setText(_translate("MainWindow", "保存"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPreset2), _translate("MainWindow", "预设组 (硬件)"))
